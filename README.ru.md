...
**Adapt Prices Bot** — автоматическая региональная ценовая оптимизация для App Store: локализует цены на встроенные покупки (IAP) и подписки в 175+ странах по паритету покупательной способности (PPP) на основе ВВП на душу населения, с опциональным AI-анализом, через App Store Connect API.
...
3. Имя: любое (например, `adapt-bot`)
